---
title: 'Loan Funded'
openapi: 'POST /fund-loan'
---

This endpoint funds the approved loan amount to the borrower. It is typically invoked after the loan has successfully completed underwriting and the borrower has transferred the required collateral. The funding transaction is recorded on-chain for transparency and auditability.
